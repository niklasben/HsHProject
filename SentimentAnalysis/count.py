...
readfile = open("../labeling/dataset_labeled/currentfinallist.txt", "r")        # Substitute tweetfile.txt with filename
writefile = open("sentiment_analysed_tweets.txt", "w")                          # Substitute output.txt with filename
