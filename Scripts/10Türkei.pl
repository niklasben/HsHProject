...
my $filename = "TweetFile_Tuerkei_".$date.".txt";
my $dir = dir("Z:/Projekt Sem 6");
my $file = file($filename);
my $file_handle = $file->openw();

  my $searchterm = "tuerkei OR turkey OR tuerkiye cumhuriyeti OR tuerkisch OR tuerke OR tuerken OR tuerkin OR tuerkinnen OR ankara OR instanbul";
