...
for line in f:
    ...
    if line[1] not in neg_topic.keys() and line[1] != 'undef' and line[2] == 'uk' and line[0] == '5':
        neg_topic[line[1].lstrip()] = 1
    elif line[1] in neg_topic.keys() and line[1] != 'undef' and line[2] == 'uk' and line[0] == '5':
        neg_topic[line[1].lstrip()] += 1
    elif line[1] not in neg_topic.keys() and line[1] != 'undef' and line[2] == 'uk':
        neg_topic[line[1].lstrip()] = 0
         
    if line[1] not in pos_topic.keys() and line[1] != 'undef' and line[2] == 'uk' and line[0] == '10':    
        pos_topic[line[1].lstrip()] = 1
    elif line[1] in pos_topic.keys() and line[1] != 'undef' and line[2] == 'uk' and line[0] == '10':
        pos_topic[line[1].lstrip()] += 1
    elif line[1] not in pos_topic.keys() and line[1] != 'undef' and line[2] == 'uk':
        pos_topic[line[1].lstrip()] = 0
    
    if line[1] not in neu_topic.keys() and line[1] != 'undef' and line[2] == 'uk' and line[0] == '0':    
        neu_topic[line[1].lstrip()] = 1
    elif line[1] in neu_topic.keys() and line[1] != 'undef' and line[2] == 'uk' and line[0] == '0':
        neu_topic[line[1].lstrip()] += 1
    elif line[1] not in neu_topic.keys() and line[1] != 'undef' and line[2] == 'uk':
