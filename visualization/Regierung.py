...
for line in f:
    ...
    if line[2] not in neg_countries.keys() and line[1] == 'Politik' and line[0] == '5':    
        neg_countries[line[2].lstrip()] = 1
        #total_countries[line[2].lstrip()] = 1
    elif line[2] in neg_countries.keys() and line[1] == 'Politik' and line[0] == '5':
        neg_countries[line[2].lstrip()] += 1
        #total_countries[line[2].lstrip()] += 1
         
    if line[2] not in pos_countries.keys() and line[1] == 'Politik' and line[0] == '10':    
        pos_countries[line[2].lstrip()] = 1
        #total_countries[line[2].lstrip()] = 1
    elif line[2] in pos_countries.keys() and line[1] == 'Politik' and line[0] == '10':
        pos_countries[line[2].lstrip()] += 1
        #total_countries[line[2].lstrip()] += 1
        
    if line[2] not in neu_countries.keys() and line[1] == 'Politik' and line[0] == '0':    
        neu_countries[line[2].lstrip()] = 1
        #total_countries[line[2].lstrip()] = 1
    elif line[2] in neu_countries.keys() and line[1] == 'Politik' and line[0] == '0':
        neu_countries[line[2].lstrip()] += 1
        #total_countries[line[2].lstrip()] += 1
...
#plt.xlabel('Countries')
ax.set_title('Label \"Politik\" fuer alle Laender')
...
plt.show()
#plt.savefig('Topic_Regierung.png')